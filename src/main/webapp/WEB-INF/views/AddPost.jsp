...
<body>
	<div class="main">
		<div class="headerContainer">
			<span class="title">방명록 작성</span>
		</div>
		<form class="form" action="/guestbook/add" method="post" onsubmit="return check()">
			<div>
			...
			<div>
				...
				<textarea class="formTextarea" cols="60" rows="10" name="content" id="content"></textarea>
			</div>
